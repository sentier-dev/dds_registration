...
def create_receipt_pdf(
    ...
    pdf.set_title("Receipt {} ({})".format(invoice_number, client_name))
    ...
    pdf.multi_cell(
        text="Receipt " + invoice_number, w=left_column_width, align=Align.L, new_x="LEFT", new_y="NEXT", h=line_height
    )
