...
class BookingSessionForm(ModelForm):
    ...
    def __init__(self, target_url, *args, **kwargs):
        ...
        self.helper.form_action = reverse(target_url, kwargs={'booking_id': self.instance.id})
...
class BookingChoicesForm(Form):
    ...
    def __init__(self, booking, *args, **kwargs):
        ...
        for choice in booking.event.choices.all():
            ...
            self.fields[field_name] = ChoiceField(label=choice.title, choices=options_choices)

        # Define the Crispy Form helper
        self.helper = FormHelper()
        self.helper.form_method = 'post'
        self.helper.form_action = reverse('booking_update', kwargs={'booking_id': self.booking.id})
...
class EventForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.form_method = 'post'
        if self.instance.pk:
            self.helper.form_action = reverse('event_update', kwargs={'event_id': self.instance.id})
        else:
...
class CategoryFormSetHelper(FormHelper):
    def __init__(self, event, *args, **kwargs):
        ...
        self.form_action = reverse('event_update_categories', kwargs={'event_id': event.id})
...
class SessionFormSetHelper(FormHelper):
    def __init__(self, event, *args, **kwargs):
        ...
        self.form_action = reverse('event_update_sessions', kwargs={'event_id': event.id})
        self.template = 'bootstrap/table_inline_formset.html'
        self.add_input(Submit('submit', 'Save'))
        self.add_input(Reset('reset', 'Reset'))
...
OptionFormSetBase = inlineformset_factory(Choice, Option, extra=3, can_delete=True, fields=['title', 'default'])
...
class OptionFormSet(OptionFormSetBase):
    def clean(self):
        ...
        self.deleted_options = [form.instance for form in self.deleted_forms if form.instance.pk]
...
class CreateBookingOnBehalfForm(Form):
    ...
    def __init__(self, event_id, *args, **kwargs):
        ...
        self.helper = FormHelper()
        self.helper.form_method = 'post'
        self.helper.form_action = reverse('booking_create_on_behalf', kwargs={'event_id': event_id})
        self.helper.form_class = 'form-horizontal'
        self.helper.label_class = 'col-lg-3'
        self.helper.field_class = 'col-lg-6'
