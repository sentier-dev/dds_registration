    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.TextField(choices=[('CREATED', 'Created'), ('ISSUED', 'Issued'), ('PAID', 'Paid'), ('REFUNDED', 'Refunded')], default='CREATED')),
                ('data', models.JSONField(blank=True, help_text='JSON object ({...})', null=True)),
                ('template', models.TextField(choices=[('M-CHF', 'Membership - Swiss Francs'), ('M-EUR', 'Membership - Euros'), ('G-USD', 'Generic - USD'), ('G-CHF', 'Generic - CHF'), ('G-EUR', 'Generic - EUR'), ('G-CAD', 'Generic - CAD')], default='G-USD')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('membership_type', models.TextField(choices=[('NORMAL', 'Normal'), ('BOARD', 'Board member'), ('HONORARY', 'Honorary'), ('BUSINESS', 'Business'), ('ACADEMIC', 'Academic')], default='NORMAL')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registrations', to='dds_registration.invoice')),
