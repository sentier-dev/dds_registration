    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.TextField(choices=[('STRIPE', 'Credit Card (Stripe)'), ('INVOICE', 'Bank Transfer (Invoice)')], default='INVOICE')),
                ...
                ('data', models.JSONField(blank=True, help_text='JSON object ({...})', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('membership_type', models.TextField(choices=[('ACADEMIC', 'Academic'), ('NORMAL', 'Normal'), ('BOARD', 'Board member'), ('HONORARY', 'Honorary'), ('BUSINESS', 'Business')], default='NORMAL')),
                ...
                ('invoice', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='memberships', to='dds_registration.invoice')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.TextField(choices=[('SUBMITTED', 'Application submitted'), ('SELECTED', 'Applicant selected'), ('WAITLIST', 'Applicant wait listed'), ('DECLINED', 'Applicant declined'), ('PAYMENT_PENDING', 'Registered (payment pending)'), ('REGISTERED', 'Registered'), ('WITHDRAWN', 'Withdrawn')])),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ...
                ('invoice', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='registrations', to='dds_registration.invoice')),
