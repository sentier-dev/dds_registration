...
urlpatterns = [
    ...
    path('event/<str:event_code>/registration/new',
         views.event_registration_new, name='event_registration_new'),
    path(
        'event/<str:event_code>/registration/new/success',
        views.event_registration_new_success,
        name='event_registration_new_success',
    ),
    path('event/<str:event_code>/registration/edit',
         views.event_registration_edit, name='event_registration_edit'),
    path(
